...
const vaibhav = {
  ...
  roles:     ["Full Stack Developer",
              "Bug Bounty Hunter"],
  learning:  ["XSS", "SQLi", "IDOR",
              "Recon", "SSRF"],
  passion:   "Secure & clean web apps",
  motto:     "Code it. Secure it. Ship it."
};
```

- 🔭 Currently building **full-stack web projects**
- 🌱 Actively learning **Bug Bounty Hunting**
- 🛡️ Passionate about **web application security**
- 🎯 Goal — First **Hall of Fame** mention
- 💬 Ask me about **JavaScript, Python, Web Security**
